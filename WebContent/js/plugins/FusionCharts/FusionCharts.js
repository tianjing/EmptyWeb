...
infosoftglobal.FusionCharts.prototype = {
	...
	getSWFHTML : function() {
		...
		if (navigator.plugins && navigator.mimeTypes
			...
			// 添加属性<param name="wmode" value="opaque" />让flash置于div下
...
render : function(elementId) {
	// First check for installed version of Flash Player - we need a minimum of
	// 8
	if ((this.detectFlashVersion == 1) && (this.installedVer.major < 8)) {
		if (this.autoInstallRedirect == 1) {
			...
			// a message in the DIV (and probably a link).
			// So, expect the developers to provide a course of way to their end
			// users.
			// window.alert("You need Adobe Flash Player 8 (or above) to view
			// the charts. It is a free and lightweight installation from
			// Adobe.com. ");
			return false;
		}
	} else {
		...
		// If loaded in IE and scaleMode and width/height specified in %, load
		// the chart using onload event
